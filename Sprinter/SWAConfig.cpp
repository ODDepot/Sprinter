/*
 ...
 Created on 4 Mar 2013 by ODDepot.com
*/
...
void setup_SWA() {
  /*
    ...
    by Sprinter, iWRAP (the firmware on the WT41) will assume it's a command and issue a
  ...
  */
  ...
  while(1){
    ...
    // Make sure there's nothing in the receive buffer
    //Serial1.flush();  // This doesn't work for some reason.
  ...
  // it's a bug in iWRAP?
  /*delay(1000);
  Serial1.write("+++");  // Switch from command mode to data mode
  delay(1000);
  Serial1.write("WT41 intialized\r\n");*/
